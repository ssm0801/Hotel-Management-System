...
public class Login extends JFrame implements ActionListener{
    ...
    ImageIcon login_image, new_login_image;
    Image img;
    JLabel login_image_label, un_label, psd_label;
    JTextField un_field;
    ...
    public Login(){
        ...
        login_image = new ImageIcon(ClassLoader.getSystemResource("images/login.jpeg"));
        img = login_image.getImage().getScaledInstance(200,200, Image.SCALE_DEFAULT);
        new_login_image = new ImageIcon(img);
        login_image_label = new JLabel(new_login_image);
